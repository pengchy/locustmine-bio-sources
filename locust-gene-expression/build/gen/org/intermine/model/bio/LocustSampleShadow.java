...
public class LocustSampleShadow implements LocustSample, ShadowClass
{
    public static final Class<LocustSample> shadowOf = LocustSample.class;
    // Attr: org.intermine.model.bio.LocustSample.phase
    protected java.lang.String phase;
    public java.lang.String getPhase() { return phase; }
    public void setPhase(final java.lang.String phase) { this.phase = phase; }

    // Attr: org.intermine.model.bio.LocustSample.tissue
    ...
    // Attr: org.intermine.model.bio.LocustSample.sampleGroup
    protected java.lang.String sampleGroup;
    public java.lang.String getSampleGroup() { return sampleGroup; }
    public void setSampleGroup(final java.lang.String sampleGroup) { this.sampleGroup = sampleGroup; }

    // Attr: org.intermine.model.bio.LocustSample.developmentStage
    protected java.lang.String developmentStage;
    public java.lang.String getDevelopmentStage() { return developmentStage; }
    public void setDevelopmentStage(final java.lang.String developmentStage) { this.developmentStage = developmentStage; }
    ...
    @Override public boolean equals(Object o) { return (o instanceof LocustSample && id != null) ? id.equals(((LocustSample)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "LocustSample [description=" + (description == null ? "null" : "\"" + description + "\"") + ", developmentStage=" + (developmentStage == null ? "null" : "\"" + developmentStage + "\"") + ", id=" + id + ", materialType=" + (materialType == null ? "null" : "\"" + materialType + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", phase=" + (phase == null ? "null" : "\"" + phase + "\"") + ", primaryCharacteristic=" + (primaryCharacteristic == null ? "null" : "\"" + primaryCharacteristic + "\"") + ", primaryCharacteristicType=" + (primaryCharacteristicType == null ? "null" : "\"" + primaryCharacteristicType + "\"") + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", publication=" + (publication == null ? "null" : (publication.getId() == null ? "no id" : publication.getId().toString())) + ", sampleGroup=" + (sampleGroup == null ? "null" : "\"" + sampleGroup + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", tissue=" + (tissue == null ? "null" : "\"" + tissue + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("sampleGroup".equals(fieldName)) {
            return sampleGroup;
        }
        if ("developmentStage".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.LocustSample.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("sampleGroup".equals(fieldName)) {
            sampleGroup = (java.lang.String) value;
        } else if ("developmentStage".equals(fieldName)) {
            developmentStage = (java.lang.String) value;
        } else if ("materialType".equals(fieldName)) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.LocustSample.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.LocustSample.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.LocustSampleShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.LocustSample");
        if (phase != null) {
            sb.append("$_^aphase$_^");
            String string = phase;
            while (string != null) {
        ...
        if (sampleGroup != null) {
            sb.append("$_^asampleGroup$_^");
            String string = sampleGroup;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (developmentStage != null) {
            sb.append("$_^adevelopmentStage$_^");
            String string = developmentStage;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.LocustSampleShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.LocustSample)");
        }
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "aphase".equals(notXml[i])) {
                ...
                phase = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "asampleGroup".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                sampleGroup = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "adevelopmentStage".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                developmentStage = string == null ? notXml[i] : string.toString();
                i++;
            }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.LocustSample.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.LocustSample.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
