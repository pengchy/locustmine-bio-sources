...
public class MonarchDiseaseAnnotationShadow implements MonarchDiseaseAnnotation, ShadowClass
{
    public static final Class<MonarchDiseaseAnnotation> shadowOf = MonarchDiseaseAnnotation.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof MonarchDiseaseAnnotation && id != null) ? id.equals(((MonarchDiseaseAnnotation)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "MonarchDiseaseAnnotation [id=" + id + ", ontologyTerm=" + (ontologyTerm == null ? "null" : (ontologyTerm.getId() == null ? "no id" : ontologyTerm.getId().toString())) + ", qualifier=" + (qualifier == null ? "null" : "\"" + qualifier + "\"") + ", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.MonarchDiseaseAnnotation.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MonarchDiseaseAnnotation.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.MonarchDiseaseAnnotation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MonarchDiseaseAnnotationShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.MonarchDiseaseAnnotation");
        if (qualifier != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.MonarchDiseaseAnnotationShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.MonarchDiseaseAnnotation)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MonarchDiseaseAnnotation.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.MonarchDiseaseAnnotation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
