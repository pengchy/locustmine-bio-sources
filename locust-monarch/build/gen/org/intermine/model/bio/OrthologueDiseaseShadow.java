...
public class OrthologueDiseaseShadow implements OrthologueDisease, ShadowClass
{
    public static final Class<OrthologueDisease> shadowOf = OrthologueDisease.class;
    // Col: org.intermine.model.bio.OrthologueDisease.monarchDiseaseTerms
    protected java.util.Set<org.intermine.model.bio.MonarchDiseaseTerm> monarchDiseaseTerms = new java.util.HashSet<org.intermine.model.bio.MonarchDiseaseTerm>();
    public java.util.Set<org.intermine.model.bio.MonarchDiseaseTerm> getMonarchDiseaseTerms() { return monarchDiseaseTerms; }
    public void setMonarchDiseaseTerms(final java.util.Set<org.intermine.model.bio.MonarchDiseaseTerm> monarchDiseaseTerms) { this.monarchDiseaseTerms = monarchDiseaseTerms; }
    public void addMonarchDiseaseTerms(final org.intermine.model.bio.MonarchDiseaseTerm arg) { monarchDiseaseTerms.add(arg); }
    ...
    @Override public boolean equals(Object o) { return (o instanceof OrthologueDisease && id != null) ? id.equals(((OrthologueDisease)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "OrthologueDisease [bootstrapScore=" + bootstrapScore + ", clusterName=" + (clusterName == null ? "null" : "\"" + clusterName + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", homologue=" + (homologue == null ? "null" : (homologue.getId() == null ? "no id" : homologue.getId().toString())) + ", homologueBootstrapScore=" + homologueBootstrapScore + ", homologueProtein=" + (homologueProtein == null ? "null" : (homologueProtein.getId() == null ? "no id" : homologueProtein.getId().toString())) + ", id=" + id + ", inParanoidScore=" + inParanoidScore + ", protein=" + (protein == null ? "null" : (protein.getId() == null ? "no id" : protein.getId().toString())) + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("monarchDiseaseTerms".equals(fieldName)) {
            return monarchDiseaseTerms;
        }
        ...
        if (!org.intermine.model.bio.OrthologueDisease.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("monarchDiseaseTerms".equals(fieldName)) {
            monarchDiseaseTerms = (java.util.Set) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.OrthologueDisease.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.OrthologueDisease.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.OrthologueDiseaseShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.OrthologueDisease");
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.OrthologueDiseaseShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.OrthologueDisease)");
        }
        ...
        monarchDiseaseTerms = new ProxyCollection<org.intermine.model.bio.MonarchDiseaseTerm>(os, this, "monarchDiseaseTerms", org.intermine.model.bio.MonarchDiseaseTerm.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("monarchDiseaseTerms".equals(fieldName)) {
            monarchDiseaseTerms.add((org.intermine.model.bio.MonarchDiseaseTerm) element);
        } else if ("evidence".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("monarchDiseaseTerms".equals(fieldName)) {
            return org.intermine.model.bio.MonarchDiseaseTerm.class;
        }
        if ("evidence".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.OrthologueDisease.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.OrthologueDisease.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
