...
public class MonarchDiseaseTermShadow implements MonarchDiseaseTerm, ShadowClass
{
    public static final Class<MonarchDiseaseTerm> shadowOf = MonarchDiseaseTerm.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof MonarchDiseaseTerm && id != null) ? id.equals(((MonarchDiseaseTerm)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "MonarchDiseaseTerm [description=" + (description == null ? "null" : "\"" + description + "\"") + ", id=" + id + ", identifier=" + (identifier == null ? "null" : "\"" + identifier + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", namespace=" + (namespace == null ? "null" : "\"" + namespace + "\"") + ", obsolete=" + (obsolete == null ? "null" : "\"" + obsolete + "\"") + ", ontology=" + (ontology == null ? "null" : (ontology.getId() == null ? "no id" : ontology.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.MonarchDiseaseTerm.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MonarchDiseaseTerm.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.MonarchDiseaseTerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MonarchDiseaseTermShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.MonarchDiseaseTerm");
        if (identifier != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.MonarchDiseaseTermShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.MonarchDiseaseTerm)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MonarchDiseaseTerm.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.MonarchDiseaseTerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
