...
public class InteractionDetailShadow implements InteractionDetail, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.InteractionDetail.organisms
    protected java.lang.String organisms;
    public java.lang.String getOrganisms() { return organisms; }
    public void setOrganisms(final java.lang.String organisms) { this.organisms = organisms; }
    ...
    @Override public String toString() { return "InteractionDetail [confidence=" + confidence + ", confidenceText=" + (confidenceText == null ? "null" : "\"" + confidenceText + "\"") + ", experiment=" + (experiment == null ? "null" : (experiment.getId() == null ? "no id" : experiment.getId().toString())) + ", id=" + id + ", interaction=" + (interaction == null ? "null" : (interaction.getId() == null ? "no id" : interaction.getId().toString())) + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organisms=" + (organisms == null ? "null" : "\"" + organisms + "\"") + ", relationshipType=" + (relationshipType == null ? "null" : "\"" + relationshipType + "\"") + ", role1=" + (role1 == null ? "null" : "\"" + role1 + "\"") + ", role2=" + (role2 == null ? "null" : "\"" + role2 + "\"") + ", shortName=" + (shortName == null ? "null" : "\"" + shortName + "\"") + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("organisms".equals(fieldName)) {
            organisms = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (organisms != null) {
            sb.append("$_^aorganisms$_^");
            String string = organisms;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "aorganisms".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                organisms = string == null ? notXml[i] : string.toString();
                i++;
            }
