...
public class InteractionShadow implements Interaction, ShadowClass
{
    ...
    @Override public String toString() { return "Interaction [id=" + id + ", participant1=" + (participant1 == null ? "null" : (participant1.getId() == null ? "no id" : participant1.getId().toString())) + ", participant2=" + (participant2 == null ? "null" : (participant2.getId() == null ? "no id" : participant2.getId().toString())) + "]"; }
