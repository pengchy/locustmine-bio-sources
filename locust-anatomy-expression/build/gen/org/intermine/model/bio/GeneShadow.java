...
public class GeneShadow implements Gene, ShadowClass
{
    ...
    // Col: org.intermine.model.bio.Gene.anatomyExpressions
    protected java.util.Set<org.intermine.model.bio.AnatomyExpression> anatomyExpressions = new java.util.HashSet<org.intermine.model.bio.AnatomyExpression>();
    public java.util.Set<org.intermine.model.bio.AnatomyExpression> getAnatomyExpressions() { return anatomyExpressions; }
    public void setAnatomyExpressions(final java.util.Set<org.intermine.model.bio.AnatomyExpression> anatomyExpressions) { this.anatomyExpressions = anatomyExpressions; }
    public void addAnatomyExpressions(final org.intermine.model.bio.AnatomyExpression arg) { anatomyExpressions.add(arg); }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("anatomyExpressions".equals(fieldName)) {
            return anatomyExpressions;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("anatomyExpressions".equals(fieldName)) {
            anatomyExpressions = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        anatomyExpressions = new ProxyCollection<org.intermine.model.bio.AnatomyExpression>(os, this, "anatomyExpressions", org.intermine.model.bio.AnatomyExpression.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("flankingRegions".equals(fieldName)) {
            ...
            anatomyExpressions.add((org.intermine.model.bio.AnatomyExpression) element);
        } else if ("introns".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("anatomyExpressions".equals(fieldName)) {
            return org.intermine.model.bio.AnatomyExpression.class;
        }
        if ("introns".equals(fieldName)) {
