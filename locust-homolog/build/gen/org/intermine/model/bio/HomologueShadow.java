...
public class HomologueShadow implements Homologue, ShadowClass
{
    ...
    @Override public String toString() { return "Homologue [bootstrapScore=" + bootstrapScore + ", clusterName=" + (clusterName == null ? "null" : "\"" + clusterName + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", homologue=" + (homologue == null ? "null" : (homologue.getId() == null ? "no id" : homologue.getId().toString())) + ", homologueBootstrapScore=" + homologueBootstrapScore + ", homologueProtein=" + (homologueProtein == null ? "null" : (homologueProtein.getId() == null ? "no id" : homologueProtein.getId().toString())) + ", id=" + id + ", inParanoidScore=" + inParanoidScore + ", protein=" + (protein == null ? "null" : (protein.getId() == null ? "no id" : protein.getId().toString())) + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
