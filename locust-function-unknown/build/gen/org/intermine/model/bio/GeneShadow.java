...
public class GeneShadow implements Gene, ShadowClass
{
    ...
    // Col: org.intermine.model.bio.Gene.functionOfAssociatedGenes
    protected java.util.Set<org.intermine.model.bio.FunctionOfAssociatedGene> functionOfAssociatedGenes = new java.util.HashSet<org.intermine.model.bio.FunctionOfAssociatedGene>();
    public java.util.Set<org.intermine.model.bio.FunctionOfAssociatedGene> getFunctionOfAssociatedGenes() { return functionOfAssociatedGenes; }
    public void setFunctionOfAssociatedGenes(final java.util.Set<org.intermine.model.bio.FunctionOfAssociatedGene> functionOfAssociatedGenes) { this.functionOfAssociatedGenes = functionOfAssociatedGenes; }
    public void addFunctionOfAssociatedGenes(final org.intermine.model.bio.FunctionOfAssociatedGene arg) { functionOfAssociatedGenes.add(arg); }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("functionOfAssociatedGenes".equals(fieldName)) {
            return functionOfAssociatedGenes;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("functionOfAssociatedGenes".equals(fieldName)) {
            functionOfAssociatedGenes = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        functionOfAssociatedGenes = new ProxyCollection<org.intermine.model.bio.FunctionOfAssociatedGene>(os, this, "functionOfAssociatedGenes", org.intermine.model.bio.FunctionOfAssociatedGene.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("flankingRegions".equals(fieldName)) {
            ...
            functionOfAssociatedGenes.add((org.intermine.model.bio.FunctionOfAssociatedGene) element);
        } else if ("UTRs".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("functionOfAssociatedGenes".equals(fieldName)) {
            return org.intermine.model.bio.FunctionOfAssociatedGene.class;
        }
        if ("UTRs".equals(fieldName)) {
