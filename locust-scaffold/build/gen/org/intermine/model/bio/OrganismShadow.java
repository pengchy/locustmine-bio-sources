...
public class OrganismShadow implements Organism, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Organism.strainIdentifier
    protected java.lang.String strainIdentifier;
    public java.lang.String getStrainIdentifier() { return strainIdentifier; }
    public void setStrainIdentifier(final java.lang.String strainIdentifier) { this.strainIdentifier = strainIdentifier; }
    ...
    // Attr: org.intermine.model.bio.Organism.strainName
    protected java.lang.String strainName;
    public java.lang.String getStrainName() { return strainName; }
    public void setStrainName(final java.lang.String strainName) { this.strainName = strainName; }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("strainName".equals(fieldName)) {
            return strainName;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("strainIdentifier".equals(fieldName)) {
            strainIdentifier = (java.lang.String) value;
        ...
        } else if ("strainName".equals(fieldName)) {
            strainName = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (strainIdentifier != null) {
            sb.append("$_^astrainIdentifier$_^");
            String string = strainIdentifier;
            while (string != null) {
        ...
        if (strainName != null) {
            sb.append("$_^astrainName$_^");
            String string = strainName;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "astrainIdentifier".equals(notXml[i])) {
                i++;
                ...
                strainIdentifier = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "astrainName".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                strainName = string == null ? notXml[i] : string.toString();
                i++;
            }
